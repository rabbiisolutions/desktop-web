...
const featuredTutors = [
  {
    name: 'Ms. Mutai Sharon', description: 'Masters Student, Mentor, 2 years of experience', key: "a1",
    stars: {
      shade: [texts.gold, texts.gold, texts.gold, texts.gold, texts.grey], key: 114
    }, comment: ['I am a passionate mathematics and physics teacher.I am currently a masters' +
    ' student at The University of Nairobi, pursuing MSc in Applied mathematics. Teaching for me is a' +
        ' Calling and helping students maximize their ability in learning.',
        'I not only teach, but mentor my students. I am strongly attached to my students and that gives me a chance to' +
  ...
  },
  {
    name: 'Mr. Calvins Okello', description: '6 years of experience, National Examiner, IT' +
        ' Educationist', key: "a2",
    stars: {
      shade: [texts.gold, texts.gold, texts.gold, texts.gold, texts.grey], key: 122
  ...
  },
  {
    ...
    stars: {
      shade: [texts.gold, texts.gold, texts.gold, texts.grey, texts.grey], key: 133
    }, comment: texts.fakeComment, areas: 'Football'
  },
  {
    name: 'Oruko Pius', description: 'Music producer, Songwriter', key: "a4",
    stars: {
      shade: [texts.gold, texts.gold, texts.gold, texts.gold, texts.gold], key: 144
